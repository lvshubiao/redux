...
let util = {
    ...
    字符串截取
    @params val 字符串
    @params start 开始位置 不传默认是0
    @params count 截取字符串的数量 默认是字符串的长度
    eg:stringSubstr(str,0,10)从0开始，截取长度为10的字符串 
    eg:stringSubstr(str,10) 从0开始截取长度为10的字符串 
    eg:stringSubstr(str) 从0开始截取所有
    */
    stringSubstr() {
        var val = arguments[0],
            start = arguments[1],
